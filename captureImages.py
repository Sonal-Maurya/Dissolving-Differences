...
def capture():
    ...
    while True:
        ...
        if num_frames < 100:
            ...
            cv2.putText(frame_copy, "FETCHING BACKGROUND...PLEASE WAIT", (50, 350), cv2.FONT_HERSHEY_SIMPLEX, 0.9,
                        (0, 0, 255), 2)
            ...
            if hand is not None:
                ...
                if num_image_taken < 1:
                    cv2.imwrite(
                        r"C:\Users\INTEL 2022\Desktop\gesture\temp\result" + "\\" + str(num_image_taken) + '.jpg',
                        threshold)
                ...
                cv2.putText(frame_copy, "No hand Detected....", (60, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (225, 255, 0),
                            2)
